...
numberOfHinges = generate22lr || generateAAA || generateCR2032 || generateCR2430 || generateMicroSD || generateSD ? 1 : battery_count_x >= 9 ? 4 : battery_count_x > 7 ? 3 : battery_count_x >= 3 ? 2 : 1;
numberOfLatches = generate22lr || generateAAA || generateCR2032 || generateCR2430 || generateMicroSD || generateSD ? 1 : battery_count_x >= 9 ? 4 : battery_count_x > 7 ? 3 : battery_count_x >= 3 ? 2 : 1;
